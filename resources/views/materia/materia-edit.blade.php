...
<!-- Modal -->
    <h5 class="modal-title" id="staticBackdropLabel">Materia</h5>
                <div class="form-row">
                    ...
                    <select type="text" value="{{$materia->facultad}}" class="form-control" name="facultad" placeholder="" id="txtfacultad" require="">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" value="{{$materia->carrera}}" class="form-control" name="carrera" placeholder="" id="txtcarrera" require="">
                        <div class="invalid-feedback">
                        </div>
                        </div>
                        ...
                        <input type="text" value="{{$materia->sigla}}" class="form-control" name="sigla" placeholder="" id="txtsigla" require="">
                        <div class="invalid-feedback">
                        </div>
                        </div>
                        ...
                        <input type="text" value="{{$materia->asignatura}}" class="form-control" name="asignatura" placeholder="" id="txtasignatura" require="">
                        <div class="invalid-feedback">
                        </div>
                        </div>
